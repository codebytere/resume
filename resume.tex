...
\cvitem{Aug. 2020 -- Present}{\textbf{Microsoft} \textit{San Francisco, CA} -- Senior Software Engineer}
...
\cvlistitem{Led development on suite of bots to handle everything from backporting to automated deploys using Two-Factor Authentication via chatops.}
\cvlistitem{Top contributor to the core Electron repository since August 2017 with over 800 substantive merged and shipped pull requests.}
...
\cvitem{\textbf{Experienced}}{C++, JavaScript, Objective-C, HTML5/CSS3, Node.js, Git, Bash}
\cvitem{\textbf{Intermediate}}{Ruby on Rails, Python, React, TypeScript, C}
