...
\cvitem{Website}{https://codebyte.re}
...
\cvitem{April 2021 -- Present}{\textbf{Microsoft} \textit{Berlin, Germany} -- Senior Software Engineer II}
\cvitem{Aug. 2020 -- April 2021}{\textbf{Microsoft} \textit{San Francisco, CA} -- Senior Software Engineer}
\cvitem{Dec. 2019 -- Aug. 2020}{\textbf{Microsoft} \textit{San Francisco, CA} -- Software Engineer II}
\renewcommand{\listitemsymbol}{\textcolor{black}{-~}}
\cvlistitem{Top contributor to the core Electron repository since August 2017 with over 1300 substantive merged and shipped pull requests.}
\cvlistitem{A primary maintainer of Electron for the over 100M desktops that rely on Electron as part of their essential suite of applications.}
...
\cvlistitem{Co-created and led the API Working Group in Electron, overseeing public API design based on project principles.}
\cvlistitem{Co-created and led the Infrastructure Working Group in Electron, overseeing the project's underlying CI and other infra.}
\cvlistitem{Led development on a suite of bots to handle everything from backporting to automated deploys using Two-Factor Authentication via ChatOps.}
\cvlistitem{Contributed to and released new versions of Node.js as member of the Node.js Technical Steering Committee and Release Team.}
\cvlistitem{Upstreamed changes and fixes to Google’s Chromium, BoringSSL and V8, and The Linux Foundation’s Node.js project.}

\cvitem{Sep. 2017 -- Dec. 2019}{\textbf{GitHub} \textit{San Francisco, CA} -- Software Engineer E3}
\renewcommand{\listitemsymbol}{\textcolor{black}{-~}}
...
\cvitem{\textbf{Experienced}}{C++, JavaScript, Objective-C, HTML5/CSS3, Node.js, Git,TypeScript, Bash}
\cvitem{\textbf{Intermediate}}{Ruby on Rails, Python, React, C}
